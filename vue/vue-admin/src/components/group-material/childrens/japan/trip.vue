<template>
  <div class="view-shTemplate-trip">
    <div class="disponse-box">
      <el-row>
        ...
        <el-col :span="16">
          ...
          <el-button type="primary">新增行程</el-button>
        </el-col>
      </el-row>
    </div>
    <div class="tabs-box">
...
<script>
  ...
  import tableOpen from './manage-trip/table-open'
  import tableClose from './manage-trip/table-close'
  import tableSearch from './manage-trip/table-search'
  export default {
    data () {
      return {
        activeName: 'open',
