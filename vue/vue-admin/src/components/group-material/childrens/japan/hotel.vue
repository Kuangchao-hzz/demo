<template>
  <div class="view-shTemplate-hotel">
    <div class="disponse-box">
      <el-row>
        ...
        <el-col :span="16">
          ...
          <el-button type="primary">新增酒店</el-button>
        </el-col>
      </el-row>
    </div>
    <div class="tabs-box">
...
<script>
  ...
  import tableOpen from './manage-hotel/table-open'
  import tableClose from './manage-hotel/table-close'
  import tableSearch from './manage-hotel/table-search'
  export default {
    data () {
      return {
        activeName: 'open',
