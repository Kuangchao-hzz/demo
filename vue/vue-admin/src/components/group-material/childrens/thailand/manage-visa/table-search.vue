      ...
      <el-table-column
        ...
        <template scope="scope">
          <el-row type="flex" justify="center">
            ...
            <el-button :disabled="!buttonIsShow(scope.row.button, 1)" class="color-dispose" type="info" size="mini">生成</el-button>
            <el-button :disabled="!buttonIsShow(scope.row.button, 2)" class="color-dispose" type="info" size="mini">日审</el-button>
            <el-button :disabled="!buttonIsShow(scope.row.button, 3)" class="color-dispose" type="info" size="mini">取消日审</el-button>
          </el-row>
        </template>
      </el-table-column>
      <el-table-column
  ...
  export default {
    ...
    methods: {
      getTableData ($page) {
        ...
        self.loading = true
        api_table.data_materialThailandVisaSearch($params).then((response) => {
          self.loading = false
